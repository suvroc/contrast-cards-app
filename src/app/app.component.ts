...
export class AppComponent {
  ...
  public choosenIcons: IconDetail[];
  public result: string = '';
  public printVisible: boolean = false;
  ...
  public show() {
    this.result = JSON.stringify(this.icons.filter(x => x.selected));
    this.printVisible = true;
    this.choosenIcons = this.icons.filter(x => x.selected);
  }

  public selectAll() {
    this.icons.forEach(x => x.selected = true);
  }
